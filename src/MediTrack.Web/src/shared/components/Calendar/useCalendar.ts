...
import type { CalendarEvent, CalendarConfig, PluginBase } from "@schedule-x/calendar";

/** ScheduleX plugin instance — any plugin conforming to PluginBase. */
type ScheduleXPlugin = PluginBase<string>;
