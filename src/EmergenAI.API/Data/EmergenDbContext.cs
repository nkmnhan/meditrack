...
namespace EmergenAI.API.Data;

/// <summary>
/// EF Core DbContext for the Emergen AI service.
/// Uses PostgreSQL with pgvector extension for vector similarity search.
/// </summary>
public sealed class EmergenDbContext : DbContext
{
    public EmergenDbContext(DbContextOptions<EmergenDbContext> options) : base(options)
    {
    }
